        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="#">
                        <img src="{{ asset('images/logo-salao2.jpg') }}" alt="Logo" class="h-10 mx-auto rounded-md">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(Auth::user() && Auth::user()->role === 'admin')
                        <x-nav-link :href="route('agendamentos.listar')" :active="request()->routeIs('agendamentos.listar')">
                            {{ __('Agendamentos') }}
                        </x-nav-link>
